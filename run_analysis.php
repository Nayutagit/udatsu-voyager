...
try {
    ...
    $combinedPrompt = "以下の音声の文字起こしを元に、以下の3つの情報をJSON形式で出力してください。\n" .
        ...
        "3. article: 読みやすく整理された記事（ブログやジャーナル形式）。見出しや箇条書きを適宜用いて、元の音声の意図や思考プロセスが伝わるように構成すること。ただし、論文やビジネスレポートのような硬い文章は絶対に避け、話者の感情や人柄が伝わるような、親しみやすく少しカジュアルな「です・ます」調（エッセイやラジオの語り口に近い自然なトーン）にしてください。そのままnote等のブログに公開できる温かみのある文章にすること。\n\n" .
