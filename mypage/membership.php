...
<body>
  <div class="container">
    ...
    <div class="udarow-info">
      <h2>ボイスジャーナリング蓄積機能とは？</h2>
      <p>
        Udatsuユーザーが、自分の「声と思考」を整文して蓄積していくための<strong>思考ストック機能</strong>です。<br><br>
        プランに応じて月間の投稿制限数が異なり、整文された投稿をいつでも見返したり、タイムラインに共有して他のユーザーとつながったりできます。<br><br>
